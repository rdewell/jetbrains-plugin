 ...
 * class {@link Schema}. To perform a validation, you have a instantiate a <code>Json.Schema</code>
 * using the factory method {@link Schema} and then call its <code>validate</code> method
 * on a JSON instance:
 * </p>
 *  
 * <pre><code>
